...
LastEditTime: 2021-01-31 16:24:21
...
class AAGRU(nn.Module):
    ...
    def forward(self, inputs, attn_input):
        ...
        for gru_output_hidden_key, (gru_output_value, gru_hidden_value) in gru_output_hiddens.items():
            attn_output_hiddens[gru_output_hidden_key] = self.attn[gru_output_hidden_key](attn_input, gru_output_value, gru_hidden_value)

        attn2_input = torch.zeros(self.batch_size, self.hidden_size)/.
